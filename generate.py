...
<footer>
  <div class="foot">
    ...
    <div><a href="{PHONE_A}">{PHONE}</a><br><a href="{root}locations/index.html">All service areas</a><br><a href="{root}guides/index.html">Guides &amp; resources</a><br><a href="{root}privacy-policy.html">Privacy policy</a> &middot; <a href="{root}terms.html">Terms</a></div>
  </div>
...
urls = ([f"{BASE_URL}/", f"{BASE_URL}/locations/", f"{BASE_URL}/guides/"]
